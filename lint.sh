...
OPTION="--recursive"
SRC_DIR="src/"
FILTER="-'build/include',-whitespace/braces,-whitespace/line_length,-legal/copyright,-build/c++11,-whitespace/indent,-whitespace/parens,-runtime/references,-build/include_subdir,+build/include_what_you_use,-runtime/indentation_namespace,-readability/casting,-build/c++17"
TMP=.tmp
