...
OPTION="--recursive"
SRC_DIR="src/"
FILTER="--filter=-build/include,-whitespace/braces,-whitespace/line_length,-legal/copyright,-build/c++11,-whitespace/indent,-whitespace/parens,-runtime/references,-build/include_subdir"
TMP=.tmp
