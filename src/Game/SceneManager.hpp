...
namespace Undertale {
    class SceneManagerExceptionSceneNotFound : public std::exception {
        public:
            const char *what() const noexcept { return "Undertale::SceneManager: Scene function not found."; };
    };
    class SceneManagerExceptionNoCurrentScene : public std::exception {
        public:
            const char *what() const noexcept { return "Undertale::SceneManager: No current scene set."; };
    };
    class SceneManagerExceptionBadParametersTemplate : public std::exception {
        public:
            const char *what() const noexcept { return "Undertale::SceneManager: Function prototype is different from provided template."; };
    };
    /**
