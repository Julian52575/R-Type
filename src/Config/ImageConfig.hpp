...
namespace Undertale {
    ...
    namespace Config {
        ...
        public:
            ...
            {
                std::string msg = "Undertale::Config::ImageConfig An error happened when trying to read from '" + fileName + "'.";
        ...
        public:
            ...
            {
                std::string msg = "Undertale::Config::ImageConfig Trying to construct from an invalid json file '" + fileName + "'.\nError: '";
        ...
        class ImageConfig {
            public:
                ...
                */
                ...
                /**
                 * @fn ImageConfig
                 * @param jsonPath The path to a json image configuration and a texture path.
                 * The image configuration must start with the 'image' field.
                 */
                explicit ImageConfig(const std::string& jsonPath, const std::string& texturePath);
                ~ImageConfig(void) = default;
                /**
                * @fn getConfig
